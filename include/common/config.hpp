...
struct ControlConfig {
    ...
    double yaw_mpc_position_weight = 1000.0;
    double pitch_mpc_position_weight = 1000.0;
    double mpc_velocity_weight = 20.0;
    double mpc_acceleration_weight = 1.0;
    double mpc_jerk_weight = 0.001;
    double yaw_target_rate_limit_rad_s = 0.3490658503988659;
    double pitch_target_rate_limit_rad_s = 0.2617993877991494;
    double mpc_target_rate_filter_tau_s = 0.04;
